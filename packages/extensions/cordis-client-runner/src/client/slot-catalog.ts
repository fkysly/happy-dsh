...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-interrupted, turn-max-tokens, turn-process, turn-tail, turn-trigger, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'client-ui-chat TurnInterruptedNodeView key \'turn-interrupted\'',
