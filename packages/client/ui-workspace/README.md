...
On a touch screen the header's search frame and its two action buttons are drawn at the 44-point minimum and the row grows to hold them, so the targets need no oversized hit layer escaping the region that clips the list.
