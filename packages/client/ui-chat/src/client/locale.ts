...
export const zh = {
  ...
  'message.turnInterrupted': '上一轮被中断',
  'message.turnInterrupted.hint': '服务重启打断了这一轮，已有输出保留在对话中。',
  'message.turnInterrupted.continue': '继续',
  'message.turnInterrupted.send': '继续',
...
export const en = {
  ...
  'message.turnInterrupted': 'The last turn was interrupted',
  'message.turnInterrupted.hint': 'The service restarted during this turn; earlier output is preserved in the conversation.',
  'message.turnInterrupted.continue': 'Continue',
  'message.turnInterrupted.send': 'continue',
  'message.tokensPerSecond': '{tps} tok/s',
