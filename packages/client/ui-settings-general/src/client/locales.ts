...
export const zh = {
  ...
  'signInCode.title': '在其他设备上登录',
  'signInCode.description': '生成一次性登录码，用来在其他设备或主屏幕 App 上登录。',
  'signInCode.create': '生成登录码',
  'signInCode.creating': '正在生成…',
  'signInCode.expires': '{time} 前有效，只能使用一次。',
  'signInCode.copy': '复制登录码',
  'signInCode.copied': '已复制',
  'signInCode.error': '无法生成登录码，请重试。',
  'signInCode.unavailable': '这台服务器不要求登录，不需要登录码。',
...
export const en = {
  ...
  'signInCode.title': 'Sign in on another device',
  'signInCode.description': 'Create a one-time code to sign in on another device or the Home Screen app.',
  'signInCode.create': 'Create sign-in code',
  'signInCode.creating': 'Creating…',
  'signInCode.expires': 'Works once, until {time}.',
  'signInCode.copy': 'Copy code',
  'signInCode.copied': 'Copied',
  'signInCode.error': 'Couldn’t create a code. Try again.',
  'signInCode.unavailable': 'This server doesn’t require sign-in, so no code is needed.',
