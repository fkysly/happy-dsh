...
Phone-width touch screens (640px or narrower) hide the split button in both headers, because the chosen application opens on the host computer, which the phone user cannot see.
