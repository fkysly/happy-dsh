...
export function apply(ctx: ClientContext): void {
  ...
  // happy-dsh does not mount the upstream internal-testing notice, so nothing
  // registers the welcome dialog below. Its component and store stay in this
  // package -- and stay covered by their own specs -- for a happy-dsh welcome
  // to reuse; only the registration is gone.
